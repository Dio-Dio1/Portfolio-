      ...
      <div className="relative z-10 h-full overflow-y-auto p-10">
        ...
        <div className="grid grid-cols-2 gap-6 mt-6">
          {projects.map((project) => (
            <div key={project.id} className="flex flex-col gap-3 border border-violet-400/20 bg-[#181818]/60 p-3 transition-all duration-200 hover:border-violet-400/60 hover:bg-[#181818]/80">
              ...
              <a href='#' className='cursor-pointer text-sm text-violet-50 hover:text-violet-300 transition-colors duration-150'>
                &gt; {project.title}
              </a>
            </div>
          ))}
